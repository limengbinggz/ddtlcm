...
write_slurm() {
    echo "#!/bin/bash
#SBATCH --job-name=indgrp_N$1_seedY$2
#SBATCH --time=6:00:00
...
module load R
Rscript --verbose 1_1_3_simu_semi_bayeslcm_heterovar_run.R $1 \$SLURM_ARRAY_TASK_ID $2" > simu_3_N$1_seedY$2.slurm
if $3
then
    sbatch simu_4_N$1_seedY$2.slurm
fi
}
