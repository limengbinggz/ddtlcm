...
write_slurm() {
    echo "#!/bin/bash
#SBATCH --job-name=indgrp_tree$1_N$2_seedY$3
#SBATCH --time=6:00:00
...
module load R
Rscript --verbose 1_1_3_simu_syn_bayeslcm_heterovar_run.R $1 $2 \$SLURM_ARRAY_TASK_ID $3" > simu_1_tree$1_N$2_seedY$3.slurm
if $4
then
